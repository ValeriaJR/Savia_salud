...
export default function Home() {
  ...
  return (
    <>
      <nav className="w-full h-20 flex justify-between px-4 items-center bg-white shadow-lg" >
        <h1 className="text-2xl ">Bienvenido</h1>
        <Image className="" src="/logo_savia.png" alt="Logo Savia" width={100} height={30} />
      </nav>
      <div className="w-full h-full flex justify-evenly flex-wrap md:flex-nowrap px-4 items-center mt-24 ">
        <figure className="rounded-lg overflow-hidden relative flex items-center justify-center">
          <img src="/foto-savia.jpg" />
          <div className="flex flex-col justify-center p-10 w-full absolute bg-black/60 left-0 top-0 h-full text-white gap-2">
            <h2 className="text-xl text-center">Bienvenido al censo de Savia salud</h2>
            <p className="text-sm">En este apartado puedes subir los archivos que envian los hospitales,
              recuerda que el censo se debe hacer una vez en el día para evitar errores en el censo, luego 
              descarga los archivos correspondientes. Feliz día.
              </p>
          </div>
        </figure>
